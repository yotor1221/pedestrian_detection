...
*Generated on: June 04, 2026 at 22:01:08*
...
- **Total Unique Pedestrians**: 10,650
- **Average Pedestrians per Frame**: 10.65
- **Pedestrian Flow Rate**: 17.70 pedestrians/second
- **Total Trajectory Points**: 113,395

**Trajectory Analysis**:
- **Longest Track**: 254 frames
- **Shortest Track**: 1 frames
- **Average Track Length**: 10.6 frames
- **Tracking Persistence**: 1.4% of video duration
...
- **Total Processing Time**: 5748.96 seconds (95.8 minutes)
- **Average Inference Speed**: 3.14 FPS
- **Real-time Factor**: 0.10x processing speed
- **Frame Processing Rate**: 3.14 frames/second
...
- **Density**: 10.65 pedestrians per frame
- **Flow Rate**: 17.70 pedestrians/second
- **Tracking Success**: 10650 unique trajectories maintained

**System Performance**:
- **Processing Speed**: 3.14 FPS (Non-real-time)
...
**Key Achievement**: Successfully processed 18,032 frames of 4K footage, identifying and tracking 10,650 unique pedestrians with persistent trajectory visualization.

---

*Research data saved to: `C:\Users\tinua\Desktop\pedestrian_detection_clean\outputs\Bole515PM/`*
*Trajectory CSV: `C:\Users\tinua\Desktop\pedestrian_detection_clean\outputs\Bole515PM\full_tracking_Bole515PM.csv`*
*Annotated Video: `C:\Users\tinua\Desktop\pedestrian_detection_clean\outputs\Bole515PM\full_detection_Bole515PM.mp4`*
