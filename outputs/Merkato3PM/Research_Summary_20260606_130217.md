...
*Generated on: June 06, 2026 at 13:02:17*
...
- **Peak Memory Usage**: 1889.5 MB
- **Memory Efficiency**: 23.6% of available RAM
...
- **Total Unique Pedestrians**: 20,726
- **Average Pedestrians per Frame**: 13.41
- **Pedestrian Flow Rate**: 34.38 pedestrians/second
- **Total Trajectory Points**: 277,861

**Trajectory Analysis**:
- **Longest Track**: 471 frames
- **Shortest Track**: 1 frames
- **Average Track Length**: 13.4 frames
- **Tracking Persistence**: 2.6% of video duration
...
- **Total Processing Time**: 9320.42 seconds (155.3 minutes)
- **Average Inference Speed**: 1.94 FPS
- **Real-time Factor**: 0.06x processing speed
- **Frame Processing Rate**: 1.94 frames/second

**Memory Efficiency**:
- **Peak Memory Usage**: 1889.5 MB
- **Memory per Frame**: 0.105 MB/frame
- **System Load**: 23.6% of 8GB RAM constraint

**SAHI Performance**:
- **Tiles per Frame**: ~20 slices
- **Total SAHI Inferences**: ~365674
...
- **Density**: 13.41 pedestrians per frame
- **Flow Rate**: 34.38 pedestrians/second
- **Tracking Success**: 20726 unique trajectories maintained

**System Performance**:
- **Processing Speed**: 1.94 FPS (Non-real-time)
...
**Key Achievement**: Successfully processed 18,058 frames of 4K footage, identifying and tracking 20,726 unique pedestrians with persistent trajectory visualization.

---

*Research data saved to: `C:\Users\tinua\Desktop\pedestrian_detection_clean\outputs\Merkato3PM/`*
*Trajectory CSV: `C:\Users\tinua\Desktop\pedestrian_detection_clean\outputs\Merkato3PM\full_tracking_Merkato3PM.csv`*
*Annotated Video: `C:\Users\tinua\Desktop\pedestrian_detection_clean\outputs\Merkato3PM\full_detection_Merkato3PM.mp4`*
