...
*Generated on: June 05, 2026 at 08:13:41*
...
- **Total Frames**: 18,048
- **Duration**: 602.5 seconds (10.0 minutes)
- **Frame Rate**: 29.96 FPS

**Pedestrian Detection Results**:
- **Total Unique Pedestrians**: 8,418
- **Average Pedestrians per Frame**: 15.59
- **Pedestrian Flow Rate**: 13.97 pedestrians/second
- **Total Trajectory Points**: 131,266

**Trajectory Analysis**:
- **Longest Track**: 728 frames
- **Shortest Track**: 1 frames
- **Average Track Length**: 15.6 frames
- **Tracking Persistence**: 4.0% of video duration
...
- **Total Processing Time**: 6408.05 seconds (106.8 minutes)
- **Average Inference Speed**: 2.82 FPS
- **Real-time Factor**: 0.09x processing speed
- **Frame Processing Rate**: 2.82 frames/second
...
- **Density**: 15.59 pedestrians per frame
- **Flow Rate**: 13.97 pedestrians/second
- **Tracking Success**: 8418 unique trajectories maintained

**System Performance**:
- **Processing Speed**: 2.82 FPS (Non-real-time)
...
**Key Achievement**: Successfully processed 18,048 frames of 4K footage, identifying and tracking 8,418 unique pedestrians with persistent trajectory visualization.

---

*Research data saved to: `C:\Users\tinua\Desktop\pedestrian_detection_clean\outputs\Kirkos3PM/`*
*Trajectory CSV: `C:\Users\tinua\Desktop\pedestrian_detection_clean\outputs\Kirkos3PM\full_tracking_Kirkos3PM.csv`*
*Annotated Video: `C:\Users\tinua\Desktop\pedestrian_detection_clean\outputs\Kirkos3PM\full_detection_Kirkos3PM.mp4`*
