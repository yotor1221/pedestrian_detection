...
*Generated on: June 07, 2026 at 14:23:00*
...
- **Peak Memory Usage**: 1921.2 MB
- **Memory Efficiency**: 24.0% of available RAM
...
- **File Name**: `Merkato12PM`
- **Resolution**: 3840x2160 (4K)
- **Total Frames**: 18,056
- **Duration**: 602.8 seconds (10.0 minutes)
- **Frame Rate**: 29.95 FPS

**Pedestrian Detection Results**:
- **Total Unique Pedestrians**: 23,040
- **Average Pedestrians per Frame**: 14.31
- **Pedestrian Flow Rate**: 38.22 pedestrians/second
- **Total Trajectory Points**: 329,729

**Trajectory Analysis**:
- **Longest Track**: 484 frames
- **Shortest Track**: 1 frames
- **Average Track Length**: 14.3 frames
- **Tracking Persistence**: 2.7% of video duration
...
- **Total Processing Time**: 9583.38 seconds (159.7 minutes)
- **Average Inference Speed**: 1.88 FPS
- **Real-time Factor**: 0.06x processing speed
- **Frame Processing Rate**: 1.88 frames/second

**Memory Efficiency**:
- **Peak Memory Usage**: 1921.2 MB
- **Memory per Frame**: 0.106 MB/frame
- **System Load**: 24.0% of 8GB RAM constraint

**SAHI Performance**:
- **Tiles per Frame**: ~20 slices
- **Total SAHI Inferences**: ~365634
...
- **Density**: 14.31 pedestrians per frame
- **Flow Rate**: 38.22 pedestrians/second
- **Tracking Success**: 23040 unique trajectories maintained

**System Performance**:
- **Processing Speed**: 1.88 FPS (Non-real-time)
...
**Key Achievement**: Successfully processed 18,056 frames of 4K footage, identifying and tracking 23,040 unique pedestrians with persistent trajectory visualization.

---

*Research data saved to: `C:\Users\tinua\Desktop\pedestrian_detection_clean\outputs\Merkato12PM/`*
*Trajectory CSV: `C:\Users\tinua\Desktop\pedestrian_detection_clean\outputs\Merkato12PM\full_tracking_Merkato12PM.csv`*
*Annotated Video: `C:\Users\tinua\Desktop\pedestrian_detection_clean\outputs\Merkato12PM\full_detection_Merkato12PM.mp4`*
