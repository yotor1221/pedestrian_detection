...
*Generated on: June 06, 2026 at 10:12:13*
...
- **Total Unique Pedestrians**: 7,534
- **Average Pedestrians per Frame**: 9.89
- **Pedestrian Flow Rate**: 12.51 pedestrians/second
- **Total Trajectory Points**: 74,516

**Trajectory Analysis**:
- **Longest Track**: 290 frames
- **Shortest Track**: 1 frames
- **Average Track Length**: 9.9 frames
- **Tracking Persistence**: 1.6% of video duration
...
- **Total Processing Time**: 4667.03 seconds (77.8 minutes)
- **Average Inference Speed**: 3.87 FPS
- **Real-time Factor**: 0.13x processing speed
- **Frame Processing Rate**: 3.87 frames/second
...
- **Density**: 9.89 pedestrians per frame
- **Flow Rate**: 12.51 pedestrians/second
- **Tracking Success**: 7534 unique trajectories maintained

**System Performance**:
- **Processing Speed**: 3.87 FPS (Non-real-time)
...
**Key Achievement**: Successfully processed 18,044 frames of 4K footage, identifying and tracking 7,534 unique pedestrians with persistent trajectory visualization.

---

*Research data saved to: `C:\Users\tinua\Desktop\pedestrian_detection_clean\outputs\Lamberet12PM/`*
*Trajectory CSV: `C:\Users\tinua\Desktop\pedestrian_detection_clean\outputs\Lamberet12PM\full_tracking_Lamberet12PM.csv`*
*Annotated Video: `C:\Users\tinua\Desktop\pedestrian_detection_clean\outputs\Lamberet12PM\full_detection_Lamberet12PM.mp4`*
